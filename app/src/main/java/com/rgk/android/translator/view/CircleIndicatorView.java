...
public class CircleIndicatorView extends View implements ViewPager.OnPageChangeListener{
   ...
   // private int mSelectColor = Color.parseColor("#E38A7C");
    ...
    private void getAttr(Context context, AttributeSet attrs){
        ...
        mRadius = (int) typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorRadius, Utils.dpToPx(6));
        mStrokeWidth = (int) typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorBorderWidth,Utils.dpToPx(2));
        mSpace = typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorSpace,Utils.dpToPx(5));
        // color
